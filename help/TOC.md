...
+ [!DNL Analytics for Adobe Advertising] {#analytics}
   ...
   + [Adobe Advertising レポートに [!DNL Marketing Channels] を使用しています](/help/integrations/analytics/analytics-reporting-a4adc.md)
   + [Adobe Advertisingのアクティベーションとレポート用に [!DNL Analytics]  プロファイルを作成](/help/integrations/analytics/analytics-profiles-a4adc.md)
   + [Adobe Analyticsを使用して、ローンチ前のキャンペーン分析を作成する](/help/integrations/analytics/analytics-pre-launch-a4adc.md)
   + [Adobe AnalyticsによるAdobe Advertisingダッシュボードの構築](/help/integrations/analytics/analytics-dashboards-a4adc.md)
   + [Adobe Advertising データで [!DNL Analytics]  カスタム指標を作成](/help/integrations/analytics/analytics-custom-metrics-a4adc.md)
