...
+ DSP {#dsp}
   ...
   + [標準ディスプレイプレースメントの作成方法](/help/dsp/placement-create.md)
...
+ [!DNL Analytics for Adobe Advertising] {#analytics}
   ...
   + [Adobe Advertisingのライセンス認証とレポート用に [!DNL Analytics]  プロファイルを作成](/help/integrations/analytics/analytics-profiles-a4adc.md)
